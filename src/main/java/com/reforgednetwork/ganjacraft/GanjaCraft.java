...
//            RenderTypeLookup.setRenderLayer(ModBlocks.INDICA_SEED.get(), RenderType.getCutout());
            RenderTypeLookup.setRenderLayer(ModBlocks.SATIVA_SEED.get(), RenderType.getCutout());
