...
@OnlyIn(Dist.CLIENT)
public class Flame extends SpriteTexturedParticle {

	private Flame(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, int maxAge) {
		super(world, x, y, z);
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Flame campfireparticle = new Flame(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 15);
